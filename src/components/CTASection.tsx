...
export default function CTASection() {
  ...
  return (
    <section className="relative overflow-hidden hero-gradient noise-overlay">
      ...
      <div ref={ref} className={`relative container-max px-4 sm:px-6 lg:px-8 py-20 sm:py-24 text-center fade-in-section ${isVisible ? "is-visible" : ""}`}>
        <motion.div
        ...
        >
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-primary-foreground mb-6 tracking-tight leading-tight">
            Ready to Scale Your Sales Team?
          </h2>
          <p className="text-lg text-primary-foreground/50 mb-10 max-w-lg mx-auto font-light">
